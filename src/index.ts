...
const PROMPT_SECTION = [
  ...
  '7. NEVER call read_image on the figures: the current model is text-only, so read_image always errors ("model does not declare image input"). Describe figures from the numeric/statistical summaries and ask the user to open the PNG/PDF files instead.',
