...
export function buildToolDefinitions(service, registerImage, getJobs) {
    return [
        ...
        },
        {
            ...
            description: 'Check or build the GO/KEGG annotation backgrounds for an organism (human/mouse/rat). Every organism is built once from KEGG REST + UniProt on first use and cached permanently; builds need internet once per organism, and all downstream enrichment/GSEA steps use the local files and never touch the network.',
            parameters: {
