...
export function buildToolDefinitions(service) {
    return [
        {
        ...
        },
        {
            ...
            execute: async (args) => {
                ...
                return guard(service.preflightProject({
                    ...
                    comparisons: args.comparisons ?? null,
                    params: args.params ?? {},
                }), log);
            },
        },
        {
            ...
            execute: async (args) => {
                const log = logCollector();
                const result = await guard(service.runStep({ projectDir: String(args.projectDir), step: args.step, rerun: args.rerun === true, onLog: log.onLog }), log);
                return result;
            },
        },
        {
