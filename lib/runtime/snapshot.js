...
export async function restoreSnapshot(ctx, snapshotPath, opts = {}) {
    ...
    if (!existsSync(ctx.libraryDir))
        throw new Error(`snapshot extracted but no library dir found at ${ctx.libraryDir}: ${err.slice(-2000)}`);
