...
### Changed
- Mouse GO/KEGG backgrounds are no longer shipped with the plugin: every organism (human/mouse/rat) is built once on first use from KEGG REST + UniProt and cached permanently (`data/` is gitignored).
